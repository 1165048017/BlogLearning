...
def texture_editing(prn, args):
    ...
    if Mode == 0: 
        # load eye mask
        uv_face_eye = imread('Data/uv-data/uv_face_eyes_mouth.png', as_gray=True)/255. 
...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--image_path', default='./images/zly3.jpg', type=str,
                        help='path to input image')
    parser.add_argument('-r', '--ref_path', default='./images/hjh.jpg', type=str, 
                        help='path to reference image(texture ref)')
    parser.add_argument('-o', '--output_path', default='./images/results/output.jpg', type=str, 
